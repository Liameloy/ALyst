...
def test_classify_dataset_data_to_classes():
    assert empty_stat.classify_dataset_data_to_classes() == {}
    assert integer_stat.classify_dataset_data_to_classes() == {1: Dataclass(class_index = 1, class_lower_bound=1, class_upper_bound=3, class_width=2), 2: Dataclass(class_index = 1, class_lower_bound=1, class_upper_bound=3, class_width=2), 3: Dataclass(class_index = 2, class_lower_bound=3, class_upper_bound=5, class_width=2), 4: Dataclass(class_index = 2, class_lower_bound=3, class_upper_bound=5, class_width=2), 5: Dataclass(class_index = 3, class_lower_bound=5, class_upper_bound=7, class_width=2), 6: Dataclass(class_index = 3, class_lower_bound=5, class_upper_bound=7, class_width=2)}
    assert floating_stat.classify_dataset_data_to_classes() == {1.1: Dataclass(class_index = 1, class_lower_bound=1.1, class_upper_bound=3.1, class_width=2), 2.01: Dataclass(class_index = 1, class_lower_bound=1.1, class_upper_bound=3.1, class_width=2), 3.5: Dataclass(class_index = 2, class_lower_bound=3.1, class_upper_bound=5.1, class_width=2), 4.1: Dataclass(class_index = 2, class_lower_bound=3.1, class_upper_bound=5.1, class_width=2), 5: Dataclass(class_index = 2, class_lower_bound=3.1, class_upper_bound=5.1, class_width=2), 6.1: Dataclass(class_index = 3, class_lower_bound=5.1, class_upper_bound=7.1, class_width=2), 6.2: Dataclass(class_index = 3, class_lower_bound=5.1, class_upper_bound=7.1, class_width=2), 7.001: Dataclass(class_index = 3, class_lower_bound=5.1, class_upper_bound=7.1, class_width=2)}
    assert big_stat.classify_dataset_data_to_classes() == {26: Dataclass(class_index = 2, class_lower_bound=22, class_upper_bound=42, class_width=20), 15: Dataclass(class_index = 1, class_lower_bound=2, class_upper_bound=22, class_width=20), 62: Dataclass(class_index = 4, class_lower_bound=62, class_upper_bound=82, class_width=20), 40: Dataclass(class_index = 2, class_lower_bound=22, class_upper_bound=42, class_width=20), 66: Dataclass(class_index = 4, class_lower_bound=62, class_upper_bound=82, class_width=20), 67: Dataclass(class_index = 4, class_lower_bound=62, class_upper_bound=82, class_width=20), 2: Dataclass(class_index = 1, class_lower_bound=2, class_upper_bound=22, class_width=20), 54: Dataclass(class_index = 3, class_lower_bound=42, class_upper_bound=62, class_width=20), 23: Dataclass(class_index = 2, class_lower_bound=22, class_upper_bound=42, class_width=20), 87: Dataclass(class_index = 5, class_lower_bound=82, class_upper_bound=102, class_width=20), 64: Dataclass(class_index = 4, class_lower_bound=62, class_upper_bound=82, class_width=20), 33: Dataclass(class_index = 2, class_lower_bound=22, class_upper_bound=42, class_width=20), 42: Dataclass(class_index = 3, class_lower_bound=42, class_upper_bound=62, class_width=20), 39: Dataclass(class_index = 2, class_lower_bound=22, class_upper_bound=42, class_width=20), 56: Dataclass(class_index = 3, class_lower_bound=42, class_upper_bound=62, class_width=20), 68: Dataclass(class_index = 4, class_lower_bound=62, class_upper_bound=82, class_width=20), 76: Dataclass(class_index = 4, class_lower_bound=62, class_upper_bound=82, class_width=20), 5: Dataclass(class_index = 1, class_lower_bound=2, class_upper_bound=22, class_width=20), 61: Dataclass(class_index = 3, class_lower_bound=42, class_upper_bound=62, class_width=20), 69: Dataclass(class_index = 4, class_lower_bound=62, class_upper_bound=82, class_width=20), 48: Dataclass(class_index = 3, class_lower_bound=42, class_upper_bound=62, class_width=20), 51: Dataclass(class_index = 3, class_lower_bound=42, class_upper_bound=62, class_width=20), 93: Dataclass(class_index = 5, class_lower_bound=82, class_upper_bound=102, class_width=20), 46: Dataclass(class_index = 3, class_lower_bound=42, class_upper_bound=62, class_width=20), 57: Dataclass(class_index = 3, class_lower_bound=42, class_upper_bound=62, class_width=20), 34: Dataclass(class_index = 2, class_lower_bound=22, class_upper_bound=42, class_width=20), 83: Dataclass(class_index = 5, class_lower_bound=82, class_upper_bound=102, class_width=20), 96: Dataclass(class_index = 5, class_lower_bound=82, class_upper_bound=102, class_width=20), 19: Dataclass(class_index = 1, class_lower_bound=2, class_upper_bound=22, class_width=20), 94: Dataclass(class_index = 5, class_lower_bound=82, class_upper_bound=102, class_width=20), 49: Dataclass(class_index = 3, class_lower_bound=42, class_upper_bound=62, class_width=20), 60: Dataclass(class_index = 3, class_lower_bound=42, class_upper_bound=62, class_width=20), 53: Dataclass(class_index = 3, class_lower_bound=42, class_upper_bound=62, class_width=20), 25: Dataclass(class_index = 2, class_lower_bound=22, class_upper_bound=42, class_width=20), 30: Dataclass(class_index = 2, class_lower_bound=22, class_upper_bound=42, class_width=20), 90: Dataclass(class_index = 5, class_lower_bound=82, class_upper_bound=102, class_width=20), 99: Dataclass(class_index = 5, class_lower_bound=82, class_upper_bound=102, class_width=20), 32: Dataclass(class_index = 2, class_lower_bound=22, class_upper_bound=42, class_width=20), 13: Dataclass(class_index = 1, class_lower_bound=2, class_upper_bound=22, class_width=20), 44: Dataclass(class_index = 3, class_lower_bound=42, class_upper_bound=62, class_width=20), 38: Dataclass(class_index = 2, class_lower_bound=22, class_upper_bound=42, class_width=20), 24: Dataclass(class_index = 2, class_lower_bound=22, class_upper_bound=42, class_width=20), 20: Dataclass(class_index = 1, class_lower_bound=2, class_upper_bound=22, class_width=20), 35: Dataclass(class_index = 2, class_lower_bound=22, class_upper_bound=42, class_width=20), 75: Dataclass(class_index = 4, class_lower_bound=62, class_upper_bound=82, class_width=20), 89: Dataclass(class_index = 5, class_lower_bound=82, class_upper_bound=102, class_width=20), 27: Dataclass(class_index = 2, class_lower_bound=22, class_upper_bound=42, class_width=20), 50: Dataclass(class_index = 3, class_lower_bound=42, class_upper_bound=62, class_width=20), 63: Dataclass(class_index = 4, class_lower_bound=62, class_upper_bound=82, class_width=20), 21: Dataclass(class_index = 1, class_lower_bound=2, class_upper_bound=22, class_width=20)}

def test_classify_dataset_classes_to_data():
    assert empty_stat.classify_dataset_classes_to_data() == {}
    assert integer_stat.classify_dataset_classes_to_data() == {1: [1, 2, 2], 2: [3, 3, 4], 3: [5, 5, 5, 6, 7, 7]}
    assert floating_stat.classify_dataset_classes_to_data() == {1: [1.1, 2.01, 2.01], 2: [3.5, 3.5, 4.1, 5, 5, 5],
                                                                3: [6.1, 6.2, 7.001, 7.001]}
    assert big_stat.classify_dataset_classes_to_data() == {1: [15, 2, 5, 19, 13, 20, 21],
                                                           2: [26, 40, 23, 33, 39, 34, 25, 30, 32, 38, 24, 35, 27],
                                                           3: [54, 42, 56, 61, 48, 51, 46, 57, 49, 60, 53, 44, 50],
                                                           4: [62, 66, 67, 64, 68, 76, 69, 75, 63],
                                                           5: [87, 93, 83, 96, 94, 90, 99, 89]}
